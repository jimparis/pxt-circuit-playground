...
export class FieldLights extends Blockly.Field {
...
`;
    ...
    private isInFlyout() {
      return !!this.sourceBlock_ && !!this.sourceBlock_.isInFlyout;
    }
    ...
    onColorClicked(e: Event, btn: SVGElement) {
      if (Blockly.browserEvents.isRightButton(e as MouseEvent)) return;
      ...
      if (this.sourceBlock_ && this.sourceBlock_.workspace) (this.sourceBlock_.workspace as any).getAudioManager().play('click');
    }
